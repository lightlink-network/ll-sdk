  ...
  [L2ChainID.LIGHTLINK_PHOENIX]: {
    l1: {
      ...
      CanonicalTransactionChain:
        '0x0000000000000000000000000000000000000000' as const,
      BondManager: '0x0000000000000000000000000000000000000000' as const,
      OptimismPortal: '0xB1Fb5A59A738c2df565d79572b0D6f348aE7cADE' as const,
      L2OutputOracle: '0x65E325A22c0F519041db69F5693EbAc3b4AE71bE' as const,
      OptimismPortal2: '0xB1Fb5A59A738c2df565d79572b0D6f348aE7cADE' as const,
      DisputeGameFactory: '0x0000000000000000000000000000000000000000' as const,
      Challenge: '0x1c1271bEE8556918092dA9238FcC77ee8be4b5Cd' as const,
    },
    l2: DEFAULT_L2_CONTRACT_ADDRESSES,
  },
}
